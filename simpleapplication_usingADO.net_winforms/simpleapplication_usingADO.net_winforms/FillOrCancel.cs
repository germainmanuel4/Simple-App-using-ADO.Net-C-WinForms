...
namespace simpleapplication_usingADO.net_winforms
{
    public partial class FillOrCancel : Form
    {
            ...
            if (IsOrderIDValid())
            {
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("Sales.uspFillOrder", connection))
                    {
                        ...
                        {
                            MessageBox.Show("The fill operation was completed.");
                            // Close the connection.
                            connection.Close();
                        }
                    }
            ...
            if (IsOrderIDValid())
            {
                ...
                using (SqlConnection connection = new SqlConnection(Properties.Settings.Default.connString))
                {
                    ...
                    using (SqlCommand sqlCommand = new SqlCommand("Sales.uspCancelOrder", connection))
                    {
                        ...
                        {
                            MessageBox.Show("The cancel operation was completed.");
                            // Close connection.
                            connection.Close();
                        }
                    }
        ...
        private void dvgCustomerOrders_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
